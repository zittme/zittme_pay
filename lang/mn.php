...
$lang->zpay_portone_pay_method = 'Payment method';
$lang->zpay_portone_pay_methods = ['CARD' => 'Card', 'VIRTUAL_ACCOUNT' => 'Virtual account', 'TRANSFER' => 'Bank transfer', 'MOBILE' => 'Mobile carrier billing', 'EASY_PAY' => 'Easy pay'];
$lang->zpay_portone_pay_method_help = 'The method the PortOne checkout opens with. The PG connected to the channel must support it.';
...
$lang->zpay_gateway_label = 'Payment method display name';
$lang->zpay_gateway_label_help = 'Name shown to customers. Leave blank to use the default (PortOne, KG Inicis, ...). e.g. Credit card · Easy pay';
...
$lang->zpay_buyer_info = 'Buyer information';
$lang->msg_payer_name_required = 'Please enter the buyer name.';
$lang->msg_payer_phone_required = 'The payment provider requires the buyer mobile phone number.';
$lang->msg_payer_email_invalid = 'The e-mail address is not valid.';
...
$lang->zpay_confirm_deposit_ask = 'Та мөнгө орсныг шалгасан уу? Баталгаажуулсны дараа төлбөр төлөгдсөн төлөвт шилжинэ.';
...
$lang->zpay_log_depositor = 'Төлөгч';
$lang->zpay_log_due = 'Хугацаа';
...
$lang->zpay_paypal_allow_krw = 'KRW захиалгын хөрвүүлсэн төлбөр';
$lang->zpay_paypal_allow_krw_label = 'KRW-ээр хийсэн захиалгад PayPal зөвшөөрөх';
$lang->zpay_paypal_allow_krw_help = 'PayPal вон-оор тооцоо хийдэггүй. Үүнийг асаавал KRW захиалгыг дээр сонгосон төлбөрийн валют руу хөрвүүлж илгээнэ. Худалдан авагчид гадаад валютын төлбөрийн цонх гарч, ханш хөдөлдөг тул буцаан олгох дүн захиалгын дүнгээс зөрж болно. Гадаадад зарж байгаа бол барааг тухайн валютаар үнэлэх нь илүү аюулгүй. Ханш тохируулсан байх шаардлагатай.';

$lang->gateway_conekta = 'Conekta (Мексик / Латин Америк)';
$lang->zpay_conekta_private_key = 'Conekta нууц түлхүүр';
$lang->zpay_conekta_key_help = 'Самбар > Хөгжүүлэгч > API түлхүүр хэсэгт үүсгэнэ. key_test бол туршилт, key_live бол бодит орчинд холбогдоно.';
$lang->zpay_conekta_webhook = 'Webhook хаяг';
$lang->zpay_conekta_webhook_help = 'Энэ хаягийг Самбар > Webhook хэсэгт бүртгэж order.paid, order.expired-г идэвхжүүлнэ үү. OXXO болон SPEI төлбөр энэ webhook-оор баталгаажна.';
$lang->zpay_conekta_methods = 'Төлбөрийн хэрэгсэл';
$lang->zpay_conekta_method_card = 'Карт';
$lang->zpay_conekta_method_cash = 'Бэлэн мөнгө (OXXO)';
$lang->zpay_conekta_method_bank_transfer = 'Шилжүүлэг (SPEI)';
$lang->zpay_conekta_methods_help = 'Төлбөрийн хуудсанд санал болгох хэрэгслүүд. Бэлэн мөнгө, шилжүүлэг нь орлого хүлээж webhook-оор дуусна.';
$lang->zpay_conekta_currency = 'Conekta валют';
$lang->zpay_conekta_currency_help = 'MXN, USD захиалга шууд, KRW захиалга дээрх нийтлэг ханшаар энэ валют руу хөрвүүлж төлнө.';
$lang->zpay_paypal_allow_krw_label_generic = 'KRW үнэтэй захиалгыг энэ хэрэгслээр төлөхийг зөвшөөрөх';
$lang->msg_conekta_auth_failed = 'Conekta баталгаажуулалт амжилтгүй. Нууц түлхүүрээ шалгана уу.';
$lang->msg_conekta_test_empty = 'Эхлээд Conekta нууц түлхүүрээ оруулна уу.';
$lang->msg_conekta_test_ok = 'Conekta-тай амжилттай холбогдлоо (%s).';
$lang->zpay_conekta_pending_guide = 'Орлого хүлээж байна. Доорх лавлагааны дугаараар төлбөл захиалга автоматаар дуусна.';
$lang->zpay_conekta_reference = 'Лавлагаа / CLABE';

...
$lang->gateway_conekta = 'Conekta (México / Latinoamérica)';
$lang->zpay_conekta_private_key = 'Clave privada de Conekta';
$lang->zpay_conekta_key_help = 'Se obtiene en Panel > Desarrolladores > Llaves API. Las claves key_test conectan al sandbox y key_live a producción.';
$lang->zpay_conekta_webhook = 'URL de webhook';
$lang->zpay_conekta_webhook_help = 'Registre esta URL en Panel > Webhooks y active order.paid y order.expired. Los pagos OXXO y SPEI se confirman mediante este webhook.';
$lang->zpay_conekta_methods = 'Métodos de pago';
$lang->zpay_conekta_method_card = 'Tarjeta';
$lang->zpay_conekta_method_cash = 'Efectivo (OXXO)';
$lang->zpay_conekta_method_bank_transfer = 'Transferencia (SPEI)';
$lang->zpay_conekta_methods_help = 'Métodos disponibles en la página de pago. Efectivo y transferencia esperan el depósito y se completan por webhook.';
$lang->zpay_conekta_currency = 'Moneda de Conekta';
$lang->zpay_conekta_currency_help = 'Los pedidos en MXN y USD se cobran tal cual; los pedidos en KRW se convierten a esta moneda con el tipo de cambio compartido.';
$lang->zpay_paypal_allow_krw_label_generic = 'Permitir pagar con este método los pedidos en KRW';
$lang->msg_conekta_auth_failed = 'Falló la autenticación con Conekta. Revise la clave privada.';
$lang->msg_conekta_test_empty = 'Ingrese primero la clave privada de Conekta.';
$lang->msg_conekta_test_ok = 'Conectado a Conekta correctamente (%s).';
$lang->zpay_conekta_pending_guide = 'En espera de depósito. Pague con la referencia indicada y el pedido se completará automáticamente.';
$lang->zpay_conekta_reference = 'Referencia / CLABE';

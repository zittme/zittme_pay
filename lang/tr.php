...
$lang->gateway_conekta = 'Conekta (Meksika / Latin Amerika)';
$lang->zpay_conekta_private_key = 'Conekta gizli anahtarı';
$lang->zpay_conekta_key_help = 'Panel > Geliştiriciler > API anahtarları altında oluşturulur. key_test ile başlayan anahtar test ortamına, key_live canlıya bağlanır.';
$lang->zpay_conekta_webhook = 'Webhook adresi';
$lang->zpay_conekta_webhook_help = 'Bu adresi Panel > Webhook altında kaydedin ve order.paid ile order.expired olaylarını açın. OXXO ve SPEI ödemeleri bu webhook ile onaylanır.';
$lang->zpay_conekta_methods = 'Ödeme yöntemleri';
$lang->zpay_conekta_method_card = 'Kart';
$lang->zpay_conekta_method_cash = 'Nakit (OXXO)';
$lang->zpay_conekta_method_bank_transfer = 'Havale (SPEI)';
$lang->zpay_conekta_methods_help = 'Barındırılan ödeme sayfasında sunulan yöntemler. Nakit ve havale yatırma bekler, webhook ile tamamlanır.';
$lang->zpay_conekta_currency = 'Conekta para birimi';
$lang->zpay_conekta_currency_help = 'MXN ve USD siparişleri olduğu gibi tahsil edilir; KRW siparişleri ortak kur ile bu para birimine çevrilir.';
$lang->zpay_paypal_allow_krw_label_generic = 'KRW fiyatlı siparişlerin bu yöntemle ödenmesine izin ver';
$lang->msg_conekta_auth_failed = 'Conekta kimlik doğrulaması başarısız. Gizli anahtarı kontrol edin.';
$lang->msg_conekta_test_empty = 'Önce Conekta gizli anahtarını girin.';
$lang->msg_conekta_test_ok = 'Conekta bağlantısı başarılı (%s).';
$lang->zpay_conekta_pending_guide = 'Ödeme bekleniyor. Aşağıdaki referansla ödeyin, sipariş otomatik tamamlanır.';
$lang->zpay_conekta_reference = 'Referans / CLABE';

...
$lang->zpay_log_depositor = 'Einzahler';
$lang->zpay_log_due = 'Faellig';
...
$lang->gateway_conekta = 'Conekta (Mexiko / Lateinamerika)';
$lang->zpay_conekta_private_key = 'Conekta Private Key';
$lang->zpay_conekta_key_help = 'Unter Dashboard > Entwickler > API-Schlüssel erstellen. key_test verbindet mit der Sandbox, key_live mit dem Live-System.';
$lang->zpay_conekta_webhook = 'Webhook-URL';
$lang->zpay_conekta_webhook_help = 'Diese URL unter Dashboard > Webhooks eintragen und order.paid sowie order.expired aktivieren. OXXO- und SPEI-Zahlungen werden über diesen Webhook bestätigt.';
$lang->zpay_conekta_methods = 'Zahlungsarten';
$lang->zpay_conekta_method_card = 'Karte';
$lang->zpay_conekta_method_cash = 'Bargeld (OXXO)';
$lang->zpay_conekta_method_bank_transfer = 'Überweisung (SPEI)';
$lang->zpay_conekta_methods_help = 'Zahlungsarten der gehosteten Checkout-Seite. Bargeld und Überweisung warten auf den Eingang und werden per Webhook abgeschlossen.';
$lang->zpay_conekta_currency = 'Conekta-Währung';
$lang->zpay_conekta_currency_help = 'MXN- und USD-Bestellungen werden direkt belastet; KRW-Bestellungen werden mit dem gemeinsamen Wechselkurs in diese Währung umgerechnet.';
$lang->zpay_paypal_allow_krw_label_generic = 'Bestellungen in KRW mit dieser Zahlungsart zulassen';
$lang->msg_conekta_auth_failed = 'Conekta-Authentifizierung fehlgeschlagen. Private Key prüfen.';
$lang->msg_conekta_test_empty = 'Zuerst den Conekta Private Key eingeben.';
$lang->msg_conekta_test_ok = 'Verbindung zu Conekta erfolgreich (%s).';
$lang->zpay_conekta_pending_guide = 'Warten auf Zahlungseingang. Mit der Referenz unten zahlen, die Bestellung wird automatisch abgeschlossen.';
$lang->zpay_conekta_reference = 'Referenz / CLABE';

...
$lang->zpay_confirm_deposit_ask = 'Bạn đã kiểm tra khoản tiền chưa? Sau khi xác nhận, thanh toán sẽ chuyển sang trạng thái hoàn tất.';
...
$lang->zpay_log_depositor = 'Nguoi nop';
$lang->zpay_log_due = 'Han';
...
$lang->zpay_paypal_allow_krw = 'Thanh toán quy đổi cho đơn hàng KRW';
$lang->zpay_paypal_allow_krw_label = 'Cho phép PayPal với đơn hàng bằng KRW';
$lang->zpay_paypal_allow_krw_help = 'PayPal không thanh toán bù trừ bằng won. Khi bật, đơn hàng KRW sẽ được quy đổi sang loại tiền thanh toán đã chọn ở trên. Người mua thấy trang thanh toán bằng ngoại tệ, và số tiền hoàn thực tế có thể khác tổng đơn hàng do tỷ giá thay đổi. Nếu bán ra nước ngoài, nên định giá sản phẩm bằng chính loại tiền đó. Cần thiết lập tỷ giá trước.';

$lang->gateway_conekta = 'Conekta (Mexico / Mỹ Latinh)';
$lang->zpay_conekta_private_key = 'Khoá bí mật Conekta';
$lang->zpay_conekta_key_help = 'Tạo tại Bảng điều khiển > Nhà phát triển > Khoá API. Khoá key_test nối sandbox, key_live nối môi trường thật.';
$lang->zpay_conekta_webhook = 'URL webhook';
$lang->zpay_conekta_webhook_help = 'Đăng ký URL này tại Bảng điều khiển > Webhook và bật order.paid, order.expired. Thanh toán OXXO và SPEI được xác nhận qua webhook này.';
$lang->zpay_conekta_methods = 'Phương thức thanh toán';
$lang->zpay_conekta_method_card = 'Thẻ';
$lang->zpay_conekta_method_cash = 'Tiền mặt (OXXO)';
$lang->zpay_conekta_method_bank_transfer = 'Chuyển khoản (SPEI)';
$lang->zpay_conekta_methods_help = 'Phương thức hiển thị trên trang thanh toán. Tiền mặt và chuyển khoản chờ nộp tiền rồi hoàn tất qua webhook.';
$lang->zpay_conekta_currency = 'Tiền tệ Conekta';
$lang->zpay_conekta_currency_help = 'Đơn MXN và USD tính nguyên; đơn KRW quy đổi sang tiền tệ này theo tỷ giá chung ở trên.';
$lang->zpay_paypal_allow_krw_label_generic = 'Cho phép đơn định giá KRW thanh toán bằng phương thức này';
$lang->msg_conekta_auth_failed = 'Xác thực Conekta thất bại. Kiểm tra khoá bí mật.';
$lang->msg_conekta_test_empty = 'Nhập khoá bí mật Conekta trước.';
$lang->msg_conekta_test_ok = 'Kết nối Conekta thành công (%s).';
$lang->zpay_conekta_pending_guide = 'Đang chờ nộp tiền. Thanh toán theo mã tham chiếu bên dưới, đơn sẽ tự hoàn tất.';
$lang->zpay_conekta_reference = 'Mã tham chiếu / CLABE';

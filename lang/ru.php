...
$lang->zpay_log_depositor = 'Плательщик';
$lang->zpay_log_due = 'Срок';
...
$lang->gateway_conekta = 'Conekta (Мексика / Латинская Америка)';
$lang->zpay_conekta_private_key = 'Секретный ключ Conekta';
$lang->zpay_conekta_key_help = 'Создаётся в Панели > Разработчикам > API-ключи. key_test подключает к песочнице, key_live к боевой среде.';
$lang->zpay_conekta_webhook = 'URL вебхука';
$lang->zpay_conekta_webhook_help = 'Зарегистрируйте этот URL в Панели > Вебхуки и включите order.paid и order.expired. Платежи OXXO и SPEI подтверждаются через этот вебхук.';
$lang->zpay_conekta_methods = 'Способы оплаты';
$lang->zpay_conekta_method_card = 'Карта';
$lang->zpay_conekta_method_cash = 'Наличные (OXXO)';
$lang->zpay_conekta_method_bank_transfer = 'Перевод (SPEI)';
$lang->zpay_conekta_methods_help = 'Способы на размещённой странице оплаты. Наличные и перевод ждут зачисления и завершаются вебхуком.';
$lang->zpay_conekta_currency = 'Валюта Conekta';
$lang->zpay_conekta_currency_help = 'Заказы в MXN и USD списываются как есть; заказы в KRW конвертируются в эту валюту по общему курсу.';
$lang->zpay_paypal_allow_krw_label_generic = 'Разрешить оплату заказов в KRW этим способом';
$lang->msg_conekta_auth_failed = 'Ошибка аутентификации Conekta. Проверьте секретный ключ.';
$lang->msg_conekta_test_empty = 'Сначала введите секретный ключ Conekta.';
$lang->msg_conekta_test_ok = 'Подключение к Conekta успешно (%s).';
$lang->zpay_conekta_pending_guide = 'Ожидается зачисление. Оплатите по указанному референсу, заказ завершится автоматически.';
$lang->zpay_conekta_reference = 'Референс / CLABE';

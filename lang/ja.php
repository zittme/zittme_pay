...
$lang->gateway_conekta = 'Conekta (メキシコ・中南米)';
$lang->zpay_conekta_private_key = 'Conekta シークレットキー';
$lang->zpay_conekta_key_help = 'ダッシュボード > 開発者 > API キーで発行します。key_test で始まるとテスト、key_live で始まると本番に接続します。';
$lang->zpay_conekta_webhook = 'Webhook URL';
$lang->zpay_conekta_webhook_help = 'ダッシュボード > Webhook にこの URL を登録し、order.paid と order.expired を有効にしてください。OXXO・SPEI の入金はこの Webhook で確定します。';
$lang->zpay_conekta_methods = '決済手段';
$lang->zpay_conekta_method_card = 'カード';
$lang->zpay_conekta_method_cash = '現金 (OXXO)';
$lang->zpay_conekta_method_bank_transfer = '銀行振込 (SPEI)';
$lang->zpay_conekta_methods_help = 'ホスト型決済ページで提供する手段です。現金・振込は入金待ちの後、Webhook で完了します。';
$lang->zpay_conekta_currency = 'Conekta 決済通貨';
$lang->zpay_conekta_currency_help = 'MXN・USD の注文はそのまま、KRW の注文は共通為替レートでこの通貨に換算して決済します。';
$lang->zpay_paypal_allow_krw_label_generic = 'KRW の注文もこの決済手段で支払えるようにする';
$lang->msg_conekta_auth_failed = 'Conekta の認証に失敗しました。シークレットキーを確認してください。';
$lang->msg_conekta_test_empty = '先に Conekta のシークレットキーを入力してください。';
$lang->msg_conekta_test_ok = 'Conekta に正常に接続できます (%s)。';
$lang->zpay_conekta_pending_guide = '入金待ちです。以下の参照番号で入金すると自動的に決済完了になります。';
$lang->zpay_conekta_reference = '参照番号 / CLABE';

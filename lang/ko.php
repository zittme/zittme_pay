...
$lang->zpay_portone_pay_method = '결제 수단';
...
$lang->zpay_portone_pay_method_help = '포트원 결제창이 열 결제 수단입니다. 채널에 연결된 PG가 해당 수단을 지원해야 합니다.';
...
$lang->zpay_gateway_label = '결제수단 표시 이름';
$lang->zpay_gateway_label_help = '고객에게 보이는 이름입니다. 비우면 기본 이름(포트원, KG이니시스 등)을 씁니다. 예: 신용카드 · 간편결제';
...
$lang->zpay_buyer_info = '구매자 정보';
$lang->msg_payer_name_required = '구매자 이름을 입력해 주세요.';
$lang->msg_payer_phone_required = '결제사 요구 사항으로 구매자 휴대폰 번호를 입력해 주세요.';
$lang->msg_payer_email_invalid = '이메일 주소 형식이 올바르지 않습니다.';
...
$lang->gateway_conekta = 'Conekta (멕시코 · 중남미)';
$lang->zpay_conekta_private_key = 'Conekta 비밀 키';
$lang->zpay_conekta_key_help = 'Conekta 대시보드 > 개발자 > API 키에서 발급합니다. key_test 로 시작하면 테스트, key_live 로 시작하면 실거래로 연결됩니다.';
$lang->zpay_conekta_webhook = '웹훅 주소';
$lang->zpay_conekta_webhook_help = 'Conekta 대시보드 > 웹훅에 이 주소를 등록하고 order.paid, order.expired 이벤트를 켜 주세요. OXXO · SPEI 입금은 이 웹훅으로 확정됩니다.';
$lang->zpay_conekta_methods = '결제수단';
$lang->zpay_conekta_method_card = '카드';
$lang->zpay_conekta_method_cash = '현금 (OXXO)';
$lang->zpay_conekta_method_bank_transfer = '계좌이체 (SPEI)';
$lang->zpay_conekta_methods_help = '호스티드 결제 페이지에 열 결제수단입니다. 현금·계좌이체는 입금 대기 후 웹훅으로 완료됩니다.';
$lang->zpay_conekta_currency = 'Conekta 결제 통화';
$lang->zpay_conekta_currency_help = 'MXN · USD 주문은 그대로 결제되고, 원화 주문은 위 공용 환율로 이 통화에 환산해 결제합니다.';
$lang->zpay_paypal_allow_krw_label_generic = '원화 주문도 이 결제수단으로 결제할 수 있게 한다';
$lang->msg_conekta_auth_failed = 'Conekta 인증에 실패했습니다. 비밀 키를 확인해 주세요.';
$lang->msg_conekta_test_empty = 'Conekta 비밀 키를 먼저 입력해 주세요.';
$lang->msg_conekta_test_ok = 'Conekta 에 정상적으로 연결됩니다 (%s).';
$lang->zpay_conekta_pending_guide = '입금 대기 중입니다. 아래 참조번호로 입금하면 자동으로 결제 완료 처리됩니다.';
$lang->zpay_conekta_reference = '참조번호 / CLABE';

...
$lang->zpay_log_depositor = 'Deposant';
$lang->zpay_log_due = 'Echeance';
...
$lang->gateway_conekta = 'Conekta (Mexique / Amérique latine)';
$lang->zpay_conekta_private_key = 'Clé privée Conekta';
$lang->zpay_conekta_key_help = 'Créée dans Tableau de bord > Développeurs > Clés API. key_test connecte au bac à sable, key_live à la production.';
$lang->zpay_conekta_webhook = 'URL du webhook';
$lang->zpay_conekta_webhook_help = 'Enregistrez cette URL dans Tableau de bord > Webhooks et activez order.paid et order.expired. Les paiements OXXO et SPEI sont confirmés par ce webhook.';
$lang->zpay_conekta_methods = 'Moyens de paiement';
$lang->zpay_conekta_method_card = 'Carte';
$lang->zpay_conekta_method_cash = 'Espèces (OXXO)';
$lang->zpay_conekta_method_bank_transfer = 'Virement (SPEI)';
$lang->zpay_conekta_methods_help = 'Moyens proposés sur la page de paiement hébergée. Espèces et virement attendent le dépôt et sont finalisés par webhook.';
$lang->zpay_conekta_currency = 'Devise Conekta';
$lang->zpay_conekta_currency_help = 'Les commandes en MXN et USD sont débitées telles quelles ; les commandes en KRW sont converties dans cette devise avec le taux partagé.';
$lang->zpay_paypal_allow_krw_label_generic = 'Autoriser les commandes en KRW avec ce moyen de paiement';
$lang->msg_conekta_auth_failed = 'Échec de l’authentification Conekta. Vérifiez la clé privée.';
$lang->msg_conekta_test_empty = 'Saisissez d’abord la clé privée Conekta.';
$lang->msg_conekta_test_ok = 'Connexion à Conekta réussie (%s).';
$lang->zpay_conekta_pending_guide = 'En attente de dépôt. Payez avec la référence ci-dessous et la commande sera finalisée automatiquement.';
$lang->zpay_conekta_reference = 'Référence / CLABE';

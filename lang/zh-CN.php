...
$lang->zpay_bank_extra = '附加项目';
$lang->zpay_bank_extra_help = '每行一项，格式为"名称=值"。例如：银行代码=002、卡号=1234-5678';
$lang->zpay_bank_extra_ph = '银行代码=002';
...
$lang->zpay_conekta_private_key = 'Conekta 私钥';
$lang->zpay_conekta_key_help = '在控制台 > 开发者 > API 密钥中获取。key_test 开头为测试，key_live 开头为正式环境。';
$lang->zpay_conekta_webhook = 'Webhook 地址';
$lang->zpay_conekta_webhook_help = '在控制台 > Webhook 中注册此地址并启用 order.paid、order.expired。OXXO 与 SPEI 付款通过此 Webhook 确认。';
$lang->zpay_conekta_methods = '支付方式';
$lang->zpay_conekta_method_card = '银行卡';
$lang->zpay_conekta_method_cash = '现金 (OXXO)';
$lang->zpay_conekta_method_bank_transfer = '银行转账 (SPEI)';
$lang->zpay_conekta_methods_help = '托管支付页面提供的方式。现金与转账需等待入账，由 Webhook 完成。';
$lang->zpay_conekta_currency = 'Conekta 结算货币';
$lang->zpay_conekta_currency_help = 'MXN、USD 订单按原币种收款，KRW 订单按上方共享汇率换算为此货币。';
$lang->zpay_paypal_allow_krw_label_generic = '允许以 KRW 计价的订单使用此支付方式';
$lang->msg_conekta_auth_failed = 'Conekta 认证失败，请检查私钥。';
$lang->msg_conekta_test_empty = '请先输入 Conekta 私钥。';
$lang->msg_conekta_test_ok = '已成功连接 Conekta (%s)。';
$lang->zpay_conekta_pending_guide = '等待入账。按以下参考号付款后订单将自动完成。';
$lang->zpay_conekta_reference = '参考号 / CLABE';
$lang->zpay_bank_due_date = '付款期限';
$lang->msg_conekta_manual_refund = '现金与转账付款无法通过 Conekta 自动退款，请手动退款。';
$lang->msg_conekta_pending = '已登记 Conekta 付款说明。';
$lang->zpay_mode_unknown = '模式未知 (首次下单后显示)';

...
$lang->zpay_portone_pay_methods = [
	'CARD' => 'Card',
	'VIRTUAL_ACCOUNT' => 'Virtual account',
	'TRANSFER' => 'Bank transfer',
	'MOBILE' => 'Mobile carrier billing',
	'EASY_PAY' => 'Easy pay',
];
...
$lang->gateway_conekta = 'Conekta (Mexico / Latin America)';
$lang->zpay_conekta_private_key = 'Conekta private key';
$lang->zpay_conekta_key_help = 'Issued under Dashboard > Developers > API keys. Keys starting with key_test connect to sandbox, key_live to production.';
$lang->zpay_conekta_webhook = 'Webhook URL';
$lang->zpay_conekta_webhook_help = 'Register this URL under Dashboard > Webhooks and enable order.paid and order.expired. OXXO and SPEI payments are confirmed through this webhook.';
$lang->zpay_conekta_methods = 'Payment methods';
$lang->zpay_conekta_method_card = 'Card';
$lang->zpay_conekta_method_cash = 'Cash (OXXO)';
$lang->zpay_conekta_method_bank_transfer = 'Bank transfer (SPEI)';
$lang->zpay_conekta_methods_help = 'Methods offered on the hosted checkout page. Cash and bank transfer wait for deposit and are completed by webhook.';
$lang->zpay_conekta_currency = 'Conekta currency';
$lang->zpay_conekta_currency_help = 'MXN and USD orders are charged as is; KRW orders are converted into this currency with the shared exchange rate above.';
$lang->zpay_paypal_allow_krw_label_generic = 'Allow orders priced in KRW to pay with this method';
$lang->msg_conekta_auth_failed = 'Conekta authentication failed. Check the private key.';
$lang->msg_conekta_test_empty = 'Enter the Conekta private key first.';
$lang->msg_conekta_test_ok = 'Connected to Conekta successfully (%s).';
$lang->zpay_conekta_pending_guide = 'Awaiting deposit. Pay with the reference below and the order will be completed automatically.';
$lang->zpay_conekta_reference = 'Reference / CLABE';
